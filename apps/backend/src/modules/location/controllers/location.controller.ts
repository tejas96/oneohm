...
export class LocationController {
  ...
  @ApiQuery({ name: 'input', description: 'Partial address text (min 3 chars)', example: 'MG Road Pune' })
  ...
  @Get('details')
  @ApiOperation({ summary: 'Fetch address components for a Google Places placeId' })
  @ApiQuery({ name: 'placeId', description: 'Google Places placeId', example: 'ChIJxxx' })
