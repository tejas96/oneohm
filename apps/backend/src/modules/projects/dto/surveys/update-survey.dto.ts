...
/**
 * DTO for updating an existing site survey
 */
export class UpdateSurveyDto {
  ...
  @ApiPropertyOptional({
    ...
    example: RoofCondition.EXCELLENT,
  ...
  @ApiPropertyOptional({
    ...
    example: RoofOrientation.SOUTHEAST,
  ...
  // ==================== Additional Data ====================
  @ApiPropertyOptional({
    example: 'Survey completed successfully, ready for installation',
