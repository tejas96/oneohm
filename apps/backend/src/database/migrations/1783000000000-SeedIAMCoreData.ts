...
export class SeedIAMCoreData1783000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (permissionCodes.length > 0) {
      ...
      await queryRunner.query(
        `DELETE FROM permissions WHERE code IN (${ph})`,
        permissionCodes,
      );
    }
    ...
    if (roleCodes.length > 0) {
      ...
      await queryRunner.query(
        `DELETE FROM roles WHERE code IN (${ph})`,
        roleCodes,
      );
    }
  }
  ...
  private getPermissions(): Array<{
    ...
    return [
      ...
      { name: 'Update Customer Status', code: 'customers:update-status', action: 'update-status', scope: 'all' },
      ...
      { name: 'Update Own Customers', code: 'customers:update:own', action: 'update', scope: 'own' },
      ...
      { name: 'Update Project Status', code: 'projects:update-status', action: 'update-status', scope: 'all' },
      { name: 'Delete Projects', code: 'projects:delete', action: 'delete', scope: 'all' },

      // project-tasks
      { name: 'Create Project Tasks', code: 'project-tasks:create', action: 'create', scope: 'all' },
      { name: 'Read Project Tasks', code: 'project-tasks:read', action: 'read', scope: 'all' },
      { name: 'Update Project Tasks', code: 'project-tasks:update', action: 'update', scope: 'all' },
      { name: 'Update Task Status', code: 'project-tasks:update-status', action: 'update-status', scope: 'all' },
      { name: 'Assign Project Tasks', code: 'project-tasks:assign', action: 'assign', scope: 'all' },
      { name: 'Delete Project Tasks', code: 'project-tasks:delete', action: 'delete', scope: 'all' },
      ...
      { name: 'Update Milestone Status', code: 'milestones:update-status', action: 'update-status', scope: 'all' },
      ...
      // workflow-steps
      { name: 'Create Workflow Steps', code: 'workflow-steps:create', action: 'create', scope: 'all' },
      { name: 'Read Workflow Steps', code: 'workflow-steps:read', action: 'read', scope: 'all' },
      { name: 'Update Workflow Steps', code: 'workflow-steps:update', action: 'update', scope: 'all' },
      { name: 'Delete Workflow Steps', code: 'workflow-steps:delete', action: 'delete', scope: 'all' },
      ...
      { name: 'Update Employee Status', code: 'employees:update-status', action: 'update-status', scope: 'all' },
      ...
      { name: 'Update User Status', code: 'users:update-status', action: 'update-status', scope: 'all' },
      ...
      { name: 'Update Reseller Status', code: 'resellers:update-status', action: 'update-status', scope: 'all' },
      { name: 'Delete Resellers', code: 'resellers:delete', action: 'delete', scope: 'all' },
      { name: 'Read Own Reseller Profile', code: 'resellers:read:own', action: 'read', scope: 'own' },
      { name: 'Update Own Reseller Profile', code: 'resellers:update:own', action: 'update', scope: 'own' },
      ...
      { name: 'Update Payment Status', code: 'payments:update-status', action: 'update-status', scope: 'all' },
      ...
      // purchase-orders
      { name: 'Create Purchase Orders', code: 'purchase-orders:create', action: 'create', scope: 'all' },
      { name: 'Read Purchase Orders', code: 'purchase-orders:read', action: 'read', scope: 'all' },
      { name: 'Update Purchase Orders', code: 'purchase-orders:update', action: 'update', scope: 'all' },
      { name: 'Approve Purchase Orders', code: 'purchase-orders:approve', action: 'approve', scope: 'all' },
      { name: 'Delete Purchase Orders', code: 'purchase-orders:delete', action: 'delete', scope: 'all' },

      // compliance
      { name: 'Create Compliance Records', code: 'compliance:create', action: 'create', scope: 'all' },
      { name: 'Read Compliance Records', code: 'compliance:read', action: 'read', scope: 'all' },
      { name: 'Update Compliance Records', code: 'compliance:update', action: 'update', scope: 'all' },
      ...
      { name: 'Delete Compliance Records', code: 'compliance:delete', action: 'delete', scope: 'all' },
      ...
      { name: 'Create Permissions', code: 'iam:permissions:create', action: 'create', scope: 'all' },
      { name: 'Update Permissions', code: 'iam:permissions:update', action: 'update', scope: 'all' },
      { name: 'Delete Permissions', code: 'iam:permissions:delete', action: 'delete', scope: 'all' },
      ...
      { name: 'Assign Permissions to Roles', code: 'iam:roles:assign-permissions', action: 'assign-permissions', scope: 'all' },
