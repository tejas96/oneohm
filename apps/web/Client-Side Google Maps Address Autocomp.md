...
NEXT_PUBLIC_GOOGLE_MAPS_API_KEY exists in apps/web/lib/config/config.ts but is unused for autocomplete
...
File: apps/web/components/features/customers/hooks/use-address-autocomplete.ts
...
File: apps/web/components/features/customers/components/address-autocomplete.tsx
...
File: apps/web/components/features/properties/components/property-form.tsx
...
apps/web/lib/hooks/use-google-maps-loader.ts
...
apps/web/lib/utils/address-utils.ts
...
Rewrite – replace backend with client-side
...
Minor – handle missing API key





apps/web/components/features/properties/components/property-form.tsx
