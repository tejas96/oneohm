...
import { PAYMENT_STATUS_BADGE_VARIANT, PAYMENT_STATUS_LABELS } from '../../../constants';
                ...
                <React.Fragment key={payment.id}>
                  ...
                  >
                    ...
                    <td className="px-3 py-2.5">
                      <Badge
                        variant={
                          (PAYMENT_STATUS_BADGE_VARIANT[payment.status] ?? 'secondary') as 'success'
                        }
                        size="xs"
                      >
...
export const ProjectPaymentsTab = React.memo(
  ({ projectId, isActive }: ProjectPaymentsTabProps): React.JSX.Element => {
    const {
      data: payments,
      isLoading,
      isError,
      error,
      refetch,
    } = useProjectPayments(projectId, { enabled: isActive });
