 ...
 */
export const ProjectFinanceTab = React.memo(function ProjectFinanceTab({
  projectId,
  isActive,
}: ProjectFinanceTabProps): JSX.Element {
  const router = useRouter();
  const searchParams = useSearchParams();

  const subParam = searchParams.get('sub');
  const initialSub: FinanceSubTab = isFinanceSubTab(subParam) ? subParam : FINANCE_DEFAULT_SUB_TAB;
