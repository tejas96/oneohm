...
export function FilterTabs<T extends string = string>({
  ...
  const variantClasses = {
    ...
    pills: {
      ...
      inactive: 'border-border-light text-foreground-secondary hover:border-primary/50 hover:text-foreground',
    },
    underline: {
      ...
      inactive: 'border-transparent text-foreground-secondary hover:text-foreground hover:border-border-medium',
    },
  };
