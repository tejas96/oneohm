...
export function applyPreGstDiscount(
  ...
  const gst5 = Math.round(((discountedBase * gstConfig.rate1Percentage) / 100) * (gstConfig.rate1 / 100) * 100) / 100;
  const gst18 = Math.round(((discountedBase * gstConfig.rate2Percentage) / 100) * (gstConfig.rate2 / 100) * 100) / 100;
